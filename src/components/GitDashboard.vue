...
<template>
  <div class="git-dashboard">
    ...
    <div class="view-switcher">
      <button v-for="option in viewOptions" :key="option.id" :class="['view-btn', { active: activeView === option.id }]"
        :title="option.label" @click="activeView = option.id">
    ...
    <div class="content-area">
      ...
      <GitVisualization v-show="activeView === 'visualization'" :current-dir="currentDir" class="view-container" />
